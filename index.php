...
<div class="container-fluid flex flex-col justify-center items-center text-white p-5"
     ...
     <h1 class="font-weight-bold mb-3" style="color: white;">Poliklinik Udinus </h1>
    ...
    <marquee style="position: absolute; bottom: 0; background-color: rgba(0,0,0,0.5); color: white; width: 100%; padding: 10px;">
        Siap Membantu Menyelesaikan Masalah Kesehatan Anda!
    </marquee>
</div>
...
<script>
    // Script untuk menambahkan copyright menggunakan JavaScript
    (function() {
        const footer = document.getElementById("footer");
        const year = new Date().getFullYear();
        footer.innerHTML = `&copy; ${year} Dibuat oleh RAFI ARIQ INU KERTAPATI`;
    })();
</script>
